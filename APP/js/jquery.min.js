!function(e, t) {
  ...
  function T(e, t) {
    if (t in e) return t;
    for (var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, i = wt.length; i--;) if (t = wt[i] + n, t in e) return t;
    return r
  }
  function w(e, t) {
    return e = t || e,
  ...
  function N(e, t) {
    ...
    n.style && (r[i] = se._data(n, "olddisplay"), t ? (r[i] || "none" !== n.style.display || (n.style.display = ""), "" === n.style.display && w(n) && (r[i] = se._data(n, "olddisplay", S(n.nodeName)))) : r[i] || w(n) || se._data(n, "olddisplay", se.css(n, "display")));
    for (i = 0; o > i; i++) n = e[i],
  ...
  function k(e, t, n, r, i) {
    for (var o = n === (r ? "border": "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2)"margin" === n && (a += se.css(e, n + Tt[o], !0, i)),
    r ? ("content" === n && (a -= se.css(e, "padding" + Tt[o], !0, i)), "margin" !== n && (a -= se.css(e, "border" + Tt[o] + "Width", !0, i))) : (a += se.css(e, "padding" + Tt[o], !0, i), "padding" !== n && (a += se.css(e, "border" + Tt[o] + "Width", !0, i)));
    return a
  }
  function E(e, t, n) {
    var r = !0,
  ...
  function B(e, t) {
    se.each(t,
    function(t, n) {
      for (var r = (tn[t] || []).concat(tn["*"]), i = 0, o = r.length; o > i; i++) if (r[i].call(e, t, n)) return
    })
  }
  function P(e, t, n) {
    var r, i, o = 0,
    ...
    u = function() {
      if (i) return ! 1;
      for (var t = Jt || O(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, a = 0, u = l.tweens.length; u > a; a++) l.tweens[a].run(o);
    ...
    c = l.props;
    for (R(c, l.opts.specialEasing); a > o; o++) if (r = en[o].call(l, e, c, l.opts)) return r;
    return B(l, c),
  ...
  se.extend({
    ...
    parseJSON: function(n) {
      return e.JSON && e.JSON.parse ? e.JSON.parse(n) : null === n ? n: "string" == typeof n && (n = se.trim(n), n && de.test(n.replace(ge, "@").replace(me, "]").replace(he, ""))) ? Function("return " + n)() : (se.error("Invalid JSON: " + n), t)
    },
    parseXML: function(n) {
      var r, i;
  ...
  se.Callbacks = function(e) {
    e = "string" == typeof e ? Te[e] || r(e) : se.extend({},
    e);
    var n, i, o, a, s, u, l = [],
    c = !e.once && [],
    f = function(t) {
  ...
  se.fn.extend({
    ...
    val: function(e) {
      var n, r, i, o = this[0];
      return arguments.length ? (i = se.isFunction(e), this.each(function(r) {
        var o, a = se(this);
      ...
      })) : o ? (n = se.valHooks[o.type] || se.valHooks[o.nodeName.toLowerCase()], n && "get" in n && (r = n.get(o, "value")) !== t ? r: (r = o.value, "string" == typeof r ? r.replace(Se, "") : null == r ? "": r)) : void 0
    }
  }),
  se.extend({
    valHooks: {
    ...
    attr: function(e, n, r) {
      ...
      if (e && 3 !== s && 8 !== s && 2 !== s) return e.getAttribute === t ? se.prop(e, n, r) : (a = 1 !== s || !se.isXMLDoc(e), a && (n = n.toLowerCase(), o = se.attrHooks[n] || (De.test(n) ? ke: Ce)), r === t ? o && a && "get" in o && null !== (i = o.get(e, n)) ? i: (e.getAttribute !== t && (i = e.getAttribute(n)), null == i ? t: i) : null !== r ? o && a && "set" in o && (i = o.set(e, r, n)) !== t ? i: (e.setAttribute(n, r + ""), r) : (se.removeAttr(e, n), t))
    },
  ...
  Me && He || (se.attrHooks.value = {
    ...
    set: function(e, n, r) {
      return se.nodeName(e, "input") ? (e.defaultValue = n, t) : Ce && Ce.set(e, n, r)
    }
  }),
  ...
  se.Event = function(e, n) {
    return this instanceof se.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || e.returnValue === !1 || e.getPreventDefault && e.getPreventDefault() ? u: l) : this.type = e, n && se.extend(this, n), this.timeStamp = e && e.timeStamp || se.now(), this[se.expando] = !0, t) : new se.Event(e, n)
  },
  se.Event.prototype = {
  ...
  function(e, t) {
    ...
    function x(e, t, n, r) {
      ...
      if (!r && 1 === l.length) {
        ...
        for (i = pe.needsContext.test(e) ? -1 : o.length - 1; i >= 0 && (a = o[i], !C.relative[s = a.type]); i--) if ((u = C.find[s]) && (r = u(a.matches[0].replace(xe, Te), de.test(o[0].type) && t.parentNode || t))) {
  ...
  se.fn.extend({
    find: function(e) {
      ...
      this.pushStack(se(e).filter(function() {
        for (t = 0; r.length > t; t++) if (se.contains(r[t], this)) return ! 0
      }));
  ...
  se.extend({
    ...
    cleanData: function(e, n) {
      ...
      f = se.event.special; null != (o = e[s]); s++) if ((n || se.acceptData(o)) && (i = o[u], r = i && l[i])) {
        if (r.events) for (a in r.events) f[a] ? se.event.remove(o, a) : se.removeEvent(o, a, r.handle);
  ...
  se.fn.extend({
    ...
    toggle: function(e) {
      ...
      return this.each(function() { (t ? e: w(this)) ? se(this).show() : se(this).hide()
      })
    }
  }),
  se.extend({
  ...
  function(e, n) {
    se.cssHooks[n] = {
      get: function(e, r, i) {
        return r ? 0 === e.offsetWidth && dt.test(se.css(e, "display")) ? se.swap(e, bt,
        function() {
          return E(e, n, i)
        }) : E(e, n, i) : t
      },
  ...
  se(function() {
    ...
    function(e, n) {
      se.cssHooks[n] = {
        get: function(e, r) {
          return r ? (r = st(e, n), mt.test(r) ? se(e).position()[n] + "px": r) : t
        }
      }
    })
  }),
  ...
  se.extend({
    ...
    ajax: function(e, n) {
      ...
      p.ifModified && (se.lastModified[o] && w.setRequestHeader("If-Modified-Since", se.lastModified[o]), se.etag[o] && w.setRequestHeader("If-None-Match", se.etag[o])),
  ...
  function(n, r, i) {
    var o, a, s, u = n.jsonp !== !1 && (zt.test(n.url) ? "url": "string" == typeof n.data && !(n.contentType || "").indexOf("application/x-www-form-urlencoded") && zt.test(n.data) && "data");
    return u || "jsonp" === n.dataTypes[0] ? (o = n.jsonpCallback = se.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, u ? n[u] = n[u].replace(zt, "$1" + o) : n.jsonp !== !1 && (n.url += (Lt.test(n.url) ? "&": "?") + n.jsonp + "=" + o), n.converters["script json"] = function() {
    ...
    i.always(function() {
      e[o] = a,
      n[o] && (n.jsonpCallback = r.jsonpCallback, It.push(o)),
  ...
  Ut && se.ajaxTransport(function(n) {
      ...
      return {
        send: function(i, o) {
          ...
          r = function(e, i) {
            var s, l, c, f, p;
            try {
              if (r && (i || 4 === u.readyState)) if (r = t, a && (u.onreadystatechange = se.noop, Yt && delete Xt[a]), i) 4 !== u.readyState && u.abort();
              else {
                f = {},
                s = u.status,
                p = u.responseXML,
          ...
          se(e).unload(Yt)), Xt[a] = r), u.onreadystatechange = r) : r()
        },
        abort: function() {
          r && r(t, !0)
        }
  ...
  se.fx.tick = function() {
    var e, n = se.timers,
    r = 0;
    for (Jt = se.now(); n.length > r; r++) e = n[r],
  ...
  se.fx.start = function() {
    Gt || (Gt = setInterval(se.fx.tick, se.fx.interval))
  },
  se.fx.stop = function() {
    clearInterval(Gt),
    Gt = null
  ...
  se.fn.offset = function(e) {
    ...
    o = this[0],
    a = o && o.ownerDocument;
    return a ? (n = a.documentElement, se.contains(n, o) ? (o.getBoundingClientRect !== t && (i = o.getBoundingClientRect()), r = z(a), {
